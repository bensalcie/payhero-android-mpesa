...
import bs.payhero.app.mpesa.services.Constants.TRANSACTION_TYPE
...
class FirstFragment : Fragment(),View.OnClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mApiClient = DarajaApiClient("XETEmT8GxTbenpG3A7PRWrQLbCjdoVAW", "lvYa03MKtgWdGCIo")
    ...
    private fun performSTKPush(phone_number: String?, amount: String) {
        ...
        val stkPush = STKPush("MPESA Android Test",amount,BUSINESS_SHORT_CODE,CALLBACKURL,
            Utils.sanitizePhoneNumber(phone_number!!)!!,PARTYB,Utils.getPassword(BUSINESS_SHORT_CODE, PASSKEY, timestamp!!)!!
        , Utils.sanitizePhoneNumber(phone_number)!!,timestamp,"Testing",TRANSACTION_TYPE)
